            ...
            <div class="col-4">
                <q-card 
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <div class="q-my-md q-mr-md text-weight-bold" style="fontSize: 18px">Sales Transaction Related Setup - Local and Foreign Currency</div>
                            <div class="q-mr-md">
                                <p>Here you will setup default local currency and foreign currencies.</p> 
                                <p>Bookkeping rate is used for room rate in foreign currency and money changer rate is used by Front Office Cashier/ money exchage.</p>
                            </div>
                        </div>
                    </div>                   
                </q-card>
...
import {tableHeadersDua} from './salesrelated.table'
