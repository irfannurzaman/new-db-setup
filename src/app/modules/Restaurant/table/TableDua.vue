<template>
  <div style="height: 450px; alignItems: center; textAlign: center" class="row">
    <div style="marginTop: -70px" class="col-8">
        <q-btn flat round>
          <img @click="onPlay" :src="iconPlay" height="120"/>
        </q-btn>
    </div>
    <div class="col-4">
      <q-card 
