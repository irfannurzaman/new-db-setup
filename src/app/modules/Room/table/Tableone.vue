      ...
      <div class="col-4">
        <q-card 
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="q-my-md q-mr-md text-weight-bold" style="fontSize: 18px">Room Related Setup - Bed Type</div>
                    <div class="q-mr-md">
                      <p>Here you will setup bed types.</p>
                      <p>Currently available bed setup can be added, edited, and removal.</p>
                    </div>
                </div>
            </div>
        </q-card>
...
import {tableHeadersOne} from './room.table'
